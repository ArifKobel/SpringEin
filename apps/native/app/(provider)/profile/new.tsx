    ...
    <Container>
      <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" >
        <View className="p-4">
          ...
          {errors.availableDays && <Text className="text-red-500 text-xs mb-2">{errors.availableDays.message as string}</Text>}
          ...
          {(errors.availableTimeFrom || errors.availableTimeTo) && (
            <Text className="text-red-500 text-xs mb-2">{errors.availableTimeFrom?.message || errors.availableTimeTo?.message}</Text>
          )}
